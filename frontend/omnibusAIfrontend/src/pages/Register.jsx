...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-72 md:w-96 h-72 md:h-96 bg-purple-500/20 rounded-full blur-[100px] animate-pulse"
      ...
      <motion.div initial={{ opacity: 0, y: 20 }}
        ...
        <Card className="border-white/10 dark:border-neutral-800 shadow-2xl backdrop-blur-xl bg-white/80 dark:bg-neutral-900/80 rounded-[2rem] p-4 md:p-8">
          ...
          <CardHeader className="space-y-2 text-center pb-8">
            <CardTitle className="text-3xl md:text-4xl font-extrabold tracking-tight">Create Account</CardTitle>
            <CardDescription className="text-sm">Start building your AI workspace today.</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div className="text-center mt-4">
                ...
                <Link to="/login" className="text-xs font-semibold text-blue-600 hover:text-blue-500">Sign in here</Link>
              </div>
